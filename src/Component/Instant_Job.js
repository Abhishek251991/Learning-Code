...
const open_data = [
  {
    ...
    datetime: '03/12/2021, 08:00AM',
    id: '#7829261420',
    bookingdate: '01/12/2021, 01:00PM',
    navigate: 'Job_Pending_Details',
  },
  {
    heading: 'Laundry',
    type: 'Womens Dress ',
    status: 'Assign Job',
    description: 'Casaual Wear',
    datetime: '04/12/2021, 10:00AM',
    id: '#7829261419',
    bookingdate: '02/12/2021, 01:00PM',
    navigate: 'Job_Assign_Details',
  },
  {
    heading: 'Cleaning',
    type: 'Mens Dress ',
    ...
    datetime: '07/12/2021, 02:00PM',
    id: '#7829261418',
    bookingdate: '05/12/2021, 03:00PM',
    navigate: 'Job_Start_Details',
  },
  {
    heading: 'Laundry',
    type: 'Mens Dress ',
    ...
    datetime: '08/12/2021, 08:00AM',
    id: '#7829261425',
    bookingdate: '06/12/2021, 04:00PM',
    navigate: 'Job_End_Details',
  },
];
const past_data = [
  {
    ...
    datetime: '03/12/2021, 08:00AM',
    id: '#7829261420',
    bookingdate: '01/12/2021, 04:00PM',
    navigate: 'Job_Completed_Details',
  },
  {
    heading: 'Laundry',
    type: 'Womens Dress ',
    status: 'Completed',
    description: 'Casaual Wear',
    datetime: '07/12/2021, 10:00AM',
    id: '#7829261419',
    bookingdate: '05/12/2021, 02:00PM',
    navigate: 'Job_Completed_Details',
  },
  {
    heading: 'Cleaning',
    ...
    datetime: '08/12/2021, 08:00AM',
    id: '#7829261417',
    bookingdate: '09/12/2021, 01:00PM',
    navigate: 'Job_Cancel_Details',
  },
];
export default class Instant_Job extends Component {
  constructor(props) {
    super(props);
    this.state = {
      openJobs: true,
  ...
  render() {
    return (
      <Container backgroundColor={Colors.whiteColor}>
        <Header goBack={() => { this.props.navigation.navigate('My_Jobs') }} title={Lang_chg.instantjobhead[config.language]} showback={true} />
        ...
        <KeyboardAwareScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                this.setState({ pastJobs: false }),
                  this.setState({ openJobs: true });
              }}
              style={{ width: '50%', alignSelf: 'center', alignItems: 'center' }}>
              <Text
                style={{
                  width: '100%',
                  textAlign: 'center',
                  ...
                  color:
                    this.state.openJobs == true
                      ? Colors.themecolor
                      : Colors.black_color,
                  fontSize: (mobileW * 4) / 100,
                }}>
                {Lang_chg.openjobs[config.language]}
              </Text>
            </TouchableOpacity>
            ...
            <View
              style={{
                ...
                borderRightColor: Colors.placeholderbordercolor,
              }}
            />

            <TouchableOpacity
              onPress={() => {
                this.setState({ pastJobs: true }),
                  this.setState({ openJobs: false });
              }}
              style={{ width: '50%', alignSelf: 'center', alignItems: 'center' }}>
              <Text
                style={{
                  ...
                  fontFamily: Font.regular_font,
                  color:
                    this.state.pastJobs == true
                      ? Colors.themecolor
                      : Colors.black_color,
                  fontSize: (mobileW * 4) / 100,
                }}>
                {Lang_chg.pastjobs[config.language]}
              </Text>
            </TouchableOpacity>
          </View>
          {this.state.openJobs == true && (
