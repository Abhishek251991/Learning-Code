...
import { Image,FlatList, Text, TouchableOpacity, View, Touchable, Platform } from 'react-native'
...
export default class After_rate_Job_Completed_Details extends Component {
    render() {
        return (
           ...
           />
            <KeyboardAwareScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
                ...
                <View style={{width:'100%',paddingBottom:mobileW*2/100,borderBottomWidth:1,borderBottomColor:Colors.placeholderbordercolor}}>
                  <View style={{width:'90%',alignSelf:'center',flexDirection:'row'}}>
                    <View style={{width:'20%'}}>
                       <Image source={require('../icons/img34.jpg')} style={{width:mobileW*18/100,height:mobileW*18/100,borderRadius:mobileW*9/100}} />
                    </View>
                    ...
                    <View style={{width:'30%',alignSelf:'center',marginTop:Platform.OS=='ios'?-mobileW*1/100:-mobileW*5/100}}>
               ...
               <View style={{width:'90%',alignSelf:'center',paddingVertical:mobileW*4/100,marginTop:mobileW*4/100,flexDirection:'row'}}>
                 <View style={{width:'60%',}}>
                     <Text style={{width:'100%',fontFamily:Font.bold_font
                     ,color:Colors.themecolor,fontSize:mobileW*4/100}}>{Lang_chg.rate_reviews[config.language]}</Text>
                 </View>
                 <View style={{width:'40%',alignItems:'center',justifyContent:'center',paddingTop:mobileW*1/100}}>
                  <Text style={{width:'100%',fontFamily:Font.regular_font
               ...
               <View style={{width:'90%',alignSelf:'center'}}>
                 <View style={{width:'100%',alignSelf:'center',flexDirection:'row'}}>
                   <View style={{width:'15%',}}>
                     <Image source={require('../icons/edit_profile.jpg')} style={{width:mobileW*12/100,height:mobileW*12/100,borderRadius:mobileW*7/100}} />
                   </View>
                   <View style={{width:'85%',}}>
                     <Text style={{fontSize:mobileW*4/100,fontFamily:Font.regular_font
                    ,color:Colors.black_color}}>{Lang_chg. henry_michael[config.language]}</Text>
