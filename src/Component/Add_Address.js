...
import { Text, Keyboard, SafeAreaView, View, StatusBar, TouchableOpacity, Image, TextInput, Platform, StyleSheet, Modal, FlatList } from 'react-native'
        ...
        return (
            <Container backgroundColor={Colors.whiteColor}>
                <Header
                    ...
                    title={Lang_chg.add_address_header[config.language]}
                    showback={true}
