...
export default class Job_End_Details extends Component {
   render() {
      return (
               ...
               <View style={{ width: '100%', paddingVertical: mobileW * 6 / 100, backgroundColor: Colors.themecolor }}>
                  <View style={{ width: '90%', alignSelf: 'center', flexDirection: 'row' }}>
                     ...
                     <View style={{ width: '25%', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                        ...
                        }}>{Lang_chg.end_job[config.language]}</Text>
                  ...
                  <View style={{ width: '100%', flexDirection: 'row', paddingVertical: mobileW * 4 / 100 }}>
                     ...
                     <View style={{ width: '20%', justifyContent: 'center' }}>
                        <Text style={{
                           width: '100%', fontFamily: Font.regular_font
                           , color: Colors.black_color, fontSize: mobileW * 3.5 / 100, textAlign: 'right'
                        }}>{Lang_chg.end_time[config.language]}</Text>
                     </View>
                  </View>
                  <View style={{ width: '100%', flexDirection: 'row', paddingBottom: mobileW * 2 / 100, borderBottomWidth: 1, borderBottomColor: Colors.placeholderbordercolor }}>
                     ...
                     <View style={{ width: '20%', justifyContent: 'center' }}>
                        <Text style={{
                           width: '100%', fontFamily: Font.regular_font
                           , color: Colors.black_color, fontSize: mobileW * 3.5 / 100, textAlign: 'right'
                        }}>{Lang_chg.extra_time[config.language]}</Text>
                     </View>
                  </View>
               </View>
               <View style={{ width: '100%', borderBottomWidth: 1, borderBottomColor: Colors.placeholderbordercolor, paddingBottom: mobileW * 4 / 100 }}>
                  <View style={{ width: '90%', alignSelf: 'center', flexDirection: 'row', paddingVertical: mobileW * 2 / 100 }}>
                     ...
                     <View style={{ width: '20%', justifyContent: 'center' }}>
                        ...
                        }}>{Lang_chg.total_time[config.language]}</Text>
                     </View>
                  </View>
               </View>
               <View style={{ width: '80%', alignSelf: 'center', flexDirection: 'row', paddingVertical: mobileW * 8 / 100 }}>
                  <View style={{ width: '45%' }}>
                     <Text style={{
                        width: '100%', fontFamily: Font.bold_font
                  ...
                  <View style={{ width: '55%', justifyContent: 'center', alignSelf: 'flex-end', alignItems: 'flex-end', marginLeft: mobileW * 8 / 100 }}>
                     <TouchableOpacity onPress={() => { this.props.navigation.navigate('Payment_Overview') }} style={{ width: '100%', borderRadius: mobileW * 1.5 / 100, backgroundColor: Colors.themecolor, paddingVertical: mobileW * 4 / 100 }}>
