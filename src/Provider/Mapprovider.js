...
import { Modal, Text, View, StyleSheet, PermissionsAndroid, SafeAreaView, Platform, TouchableOpacity, Image } from 'react-native'
import { Colors, mediaprovider, Font, config, localStorage, localimag, Currentltlg, Lang_chg, mobileW } from './utilslib/Utils';
...
export default class Mapprovider extends Component {
  ...
  getalldata = (position) => {
    ...
    this.getadddressfromlatlong(data)
  }
    ...
    return (
      ...
      <SafeAreaView style={[styles.container1]}>
        <View style={styles.container}>
          ...
          <View style={{ width: '100%', alignSelf: 'center', flexDirection: 'row', paddingTop: 10, backgroundColor: Colors.themecolor }}>
            ...
            <View style={{ paddingVertical: 15, width: '60%' }}>
              <Text style={{ color: 'black', fontFamily: Font.bold_font, fontSize: 17, textAlign: 'center' }}>Select location</Text>
            </View>
            <TouchableOpacity style={{ paddingVertical: 15, width: '20%', alignSelf: 'center' }} onPress={() => { this.props.navigation.goBack() }}>
              <View style={{ width: '100%', alignSelf: 'center' }} >
                <Text style={{ color: Colors.buttoncolor, fontSize: 13, textAlign: 'center' }}></Text>
              </View>
            </TouchableOpacity>
          ...
          <View style={{ position: 'absolute', bottom: 15, width: mobileW, paddingHorizontal: 30 }}>
            <View style={{ borderRadius: 10, height: 50, marginBottom: 10, backgroundColor: Colors.themecolor }} >
              ...
              <TouchableOpacity onPress={() => { this.props.navigation.goBack() }} style={{ justifyContent: 'center', alignItems: 'center', borderRadius: 10, height: 50, }}>
