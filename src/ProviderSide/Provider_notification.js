...
export default function Provider_notification(props) {
        ...
        <View style={{ width: '100%' }}>
          {notification_arr != 'NA' && <FlatList
            ...
            renderItem={({ item, index }) => {
              return (
                <View style={{ width: mobileW * 95 / 100, alignSelf: 'center', flexDirection: 'row', marginTop: mobileW * 7 / 100, paddingBottom: mobileW * 2 / 100, borderBottomWidth: 1, borderBottomColor: Colors.gray_color }}>
                  ...
                  <View style={{ width: mobileW * 65 / 100 }}>
                    <View style={{ width: '100%' }}>
                      <Text style={{marginLeft:2, fontFamily: Font.semibold_font, fontSize: mobileW * 4 / 100, color: Colors.black_color }}>{item.message}</Text>
                    </View>

                    <View style={{ width: '100%' }}>
                      <Text style={{marginLeft:2, fontFamily: Font.semibold_font, fontSize: mobileW * 2.8 / 100, color: Colors.msg_color }}>{item.createtime}</Text>
                    </View>
                  </View>
