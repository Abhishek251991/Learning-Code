...
export default class Provider_InstantJobs_Completed_Jobs_Details extends Component {
   constructor(props){
      super(props)
      this.state={
            ...
            <KeyboardAwareScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
                <View style={{width:'100%',paddingVertical:mobileW*7/100,backgroundColor:Colors.themecolor}}>
                  ...
                  <View style={{width:'90%',alignSelf:'center'}}>
                    <Text style={{width:'100%',color:Colors.whiteColor,
                paddingHorizontal:mobileW*1/100,fontFamily:Font.semibold_font,fontSize:mobileW*4/100}}>{Lang_chg.details_hours[config.language]}</Text>
                  </View>
                </View>
                ...
                <View style={{width:'90%',alignSelf:'center',flexDirection:'row',paddingVertical:mobileW*3/100}}>
                        ...
                        <View style={{width:'20%',justifyContent:'center'}}>
                        <Text style={{width:'100%',fontFamily:Font.bold_font
                            ,color:Colors.themecolor,fontSize:mobileW*4/100,textAlign:'right'}}>{Lang_chg.Provider_Completed_job_amount[config.language]}</Text>
                        </View>
                      </View>
                </View>
